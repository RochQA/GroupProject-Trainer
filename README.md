# GroupProject-Trainer
The purpose of the trainer microservice is to check whether the new or updated trainers details are vaid, or is trainers with conflicting details already exist.
